...
/**
 * Created by sharda on 11/21/2017.
 */
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.dimen_20dp);
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorGrayLight));
